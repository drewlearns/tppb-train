                  ...
                  children: [
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return AlertDialog(
                                                                      title: const Text(
                                                                          'Information'),
                                                                      content: const Text(
                                                                          'It is recommended to select a data 1 year out. Budgets need to be revisited from time to time.'),
                                                                      actions: [
                                                                        TextButton(
                                                                          onPressed: () =>
                                                                              Navigator.pop(alertDialogContext),
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        if ((_model.addBillOutputSkip?.succeeded ?? true)) {
                          await showDialog(
                            context: context,
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: Text(TppbGroup.addBillCall.message(
                                  (_model.addBillOutputSkip?.jsonBody ?? ''),
                                )!),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'fdjy4ypf' /* You can access the tutorial an... */,
                      ),
                      textAlign: TextAlign.center,
