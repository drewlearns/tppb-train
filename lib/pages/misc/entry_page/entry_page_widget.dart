                        ...
                        children: [
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Image.asset(
                                'assets/images/main-logo-full-size.png',
                                width: 100.0,
                                height: 100.0,
                                fit: BoxFit.cover,
                              ),
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '7mnnyn4f' /* The Purple Piggy Bank */,
                              ),
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'vd7mb0d1' /* Silly Name, Serious Budgeting */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
