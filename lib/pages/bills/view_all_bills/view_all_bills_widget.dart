...
class _ViewAllBillsWidgetState extends State<ViewAllBillsWidget> {
  late ViewAllBillsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewAllBillsModel());
                                ...
                                child: FutureBuilder<ApiCallResponse>(
                                  future: (_model.apiRequestCompleter ??=
                                          Completer<ApiCallResponse>()
                                            ..complete(
                                                TppbGroup.getAllBillsCall.call(
                                              authenticationToken:
                                                  currentJwtToken,
                                              householdIdGlobal:
                                                  widget.householdId,
                                    ...
                                    return Builder(
                                      builder: (context) {
                                        final bills = TppbGroup.getAllBillsCall
                                                .billsList(
                                                  dueBillsListViewGetAllBillsResponse
                                                      .jsonBody,
                                                )
                                                ?.map((e) => e)
                                                .toList()
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            TppbGroup.getAllBillsCall.billName(
                                                                              dueBillsListViewGetAllBillsResponse.jsonBody,
                                                                            )?[billsIndex],
                                                                            'Loading...',
                                                                          ),
