                                  ...
                                  children: [
                                    Expanded(
                                      child: FlutterFlowDropDown<int>(
                                        controller:
                                            _model.dayOfMonthValueController ??=
                                                FormFieldController<int>(
                                          _model.dayOfMonthValue ??= null,
                                        ),
                                    ...
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          8.0, 0.0, 0.0, 0.0),
                                      child: Semantics(
                                        label: 'Click to view more information',
                                        child: InkWell(
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  ...
                                                  content: const Text(
                                                      'Select the day of the month your bill landed on most recently. The Purple Piggybank app will schedule it for the current month on that date and based on the frequency there after.'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
                                    ...
                                    Expanded(
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        optionLabels: [
                                          ...
                                          FFLocalizations.of(context).getText(
                                            'aahmo7d6' /* Weekly ( 7 days ) */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'xijr6her' /* Bi-Weekly ( 14 days) */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'j0a5hpyz' /* Monthly ( 30 days ) */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            '63fezisq' /* Bi-Monthly ( 60 Days ) */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'bqw13efk' /* Quarterly ( 90 days ) */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'ny6rz7w2' /* Semi-Annually ( 180 days ) */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'xg1kmor2' /* Annually ( Yearly) */,
                                          )
                                        ],
                                        onChanged: (val) => setState(
                                                  ...
                                                  await showDialog(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        ...
                                                        content: const Text(
                                                            'Bill username and passwords are stored securely however anyone with access to your household will have access to view them. (Optional)'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if ((_model.addBillOutput?.succeeded ??
                                            true)) {
                                          await showDialog(
                                            context: context,
                                            builder: (alertDialogContext) {
